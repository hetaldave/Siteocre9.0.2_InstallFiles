param(
	[string]$EngineSuffix = 'HoFXc',
    [string]$SitePrefix = "HoFXc",
	[string]$ScInstallDirectory = "C:\inetpub\wwwroot",
	[string]$SiteHostHeaderName = "HOFXc.local.com",
	[string]$SqlServer = ".\",
	[string]$SqlDbPrefix = "HoFXc",
	[string]$CommerceEngineCertificatePath = "..\HofXc.local.cer",
	[string]$CommerceSearchProvider = "SOLR",
	[string]$SolrUrl = "https://localhost:8983/solr",
	[string]$SolrRoot = "C:\Projects\HoFXc\Solr\solr-6.6.2\",
	[string]$SolrService = "solr-6.6.2-HOFXc"
)
